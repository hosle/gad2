...
import com.userim.util.ImageLoadOptions;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(ct).inflate(
					...
					R.layout.item_user_friendpt, null);
			viewHolder = new ViewHolder();
			viewHolder.alpha = (TextView) convertView.findViewById(R.id.alpha_userim);
			viewHolder.name = (TextView) convertView
					.findViewById(R.id.tv_friend_name_userim);
			viewHolder.avatar = (ImageView) convertView
					.findViewById(R.id.img_friend_avatar_userim);
